...
export default function Input({ label = "", value, action, defaultDisable = false, property}: InputProps) {
  return (
    <div className="mb-4">
      <label className="block text-textPrimary text-sm mb-1 break-all">{label}{label?":":""}</label>
      <input
        type="text"
